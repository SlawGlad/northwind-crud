...
public class Suppliers implements Serializable {
    ...
    @Id
    @GenericGenerator(name = "suppliersGenerator", strategy = "increment")
    @GeneratedValue(generator = "suppliersGenerator")
    ...
    public String[] toArray() {
        String[] fields = {String.valueOf(supplierId), companyName, contactName, contactTitle,
